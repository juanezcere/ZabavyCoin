...
def mine_block():
    ...
    blockchain.add_transaction(sender=node_address, receiver="Juanez", amount=1)
...
def connect_node():
    ...
    if nodes is None:
        return "No hay una lista de nodos.", 401
    for node in nodes:
        blockchain.add_node(node)
    response = {"message": "Todos los nodos estan ahora conectados, el blockchain contiene los siguientes nodos:",
...
def replace_chain():
    ...
    if is_chain_replaced:
        response = {"message": "Los nodos tenian diferentes cadenas entonces fue reeplazada por la mas larga.",
